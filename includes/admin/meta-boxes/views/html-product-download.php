...
<tr>
	...
	<td class="file-limit"><input type="number" step="1" min="0" class="input_text" placeholder="<?php esc_attr_e( 'Unlimited', 'woocommerce' ); ?>" name="_wc_table_file_limits[]" value="<?php echo esc_attr( isset( $file['limit'] ) && -1 < $file['limit'] ? $file['limit'] : '' ); ?>" /></td>
	<td class="file-expiry"><input type="number" step="1" min="0" class="input_text" placeholder="<?php esc_attr_e( 'Never', 'woocommerce' ); ?>" name="_wc_table_file_expiries[]" value="<?php echo esc_attr( isset( $file['expiry'] ) && -1 < $file['expiry'] ? $file['expiry'] : '' ); ?>" /></td>
