	...
	public static function activate() {
		...
		$tables = "
			CREATE TABLE {$wpdb->prefix}wc_products (
			  ...
			  `height` decimal(30,14) NULL default NULL,
			  `width` decimal(30,14) NULL default NULL,
			  `length` decimal(30,14) NULL default NULL,
			  `weight` decimal(30,14) NULL default NULL,
			  `stock_quantity` decimal(30,14) NULL default NULL,
			  ...
			  `total_sales` decimal(30,14) NULL default 0,
			  `price` decimal(30,14) NULL default NULL,
			  `regular_price` decimal(30,14) NULL default NULL,
			  `sale_price` decimal(30,14) NULL default NULL,
			  `date_on_sale_from` datetime NULL default NULL,
			  `date_on_sale_to` datetime NULL default NULL,
			  `average_rating` decimal(30,14) NULL default 0,
